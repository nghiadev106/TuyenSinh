...
```js
toastr.options.timeOut = 30; // How int the toast will display without user interaction
toastr.options.extendedTimeOut = 60; // How int the toast will display after a user hovers over it
```
...
### Progress Bar
Visually indicate how int before a toast expires.
```js
